label follow_mimi:
    ...
    mimi "{size=-5}... nevermind.{/size}"
    ai "N--"
    ai "Yamada... You have a crush on Aoi, don't you?!"
    mimi "{size=-10}n- noooo{/size}"
    ai "You really do..."
...
label trade_info_mimi:
    if knows_about_missing_lab_notebook is False:
        ...
        ai "Apparently, her parents won the Z-Prize back in 1993."
        mimi "The... um..."
        "Mimi opened up her red notebook and flipped through it."
        mimi "I knew that didn't sound right..."
        mimi "The thing is, the Z-Prize didn't happen in 1993. The ceremony was cancelled."
